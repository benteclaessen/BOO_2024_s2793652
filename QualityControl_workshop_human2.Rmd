...
## Metadata
```{r}
metadata <- fread(input = file.path(input_dir, "SP0173_human_cyclosporin_metadata2.csv"))
```

## Countdata
```{r}
countdata_raw <- fread(input = file.path(input_dir, "SP0173_human_cyclosporin_rawcounts2.csv"))
```
...
metadata <- metadata %>% 
  ...
  dplyr::rename("CONCENTRATION" = DOSE)
...
```
```{r}
#metadata <- metadata %>%  rename("CONCENTRATION" = DOSE)
unique(expand(metadata, nesting(COMPOUND, CONCENTRATION, TIMEPOINT)))
```

```{r}
countdata_raw$PROBE_ID
```
...
order <- c("HPPTEC_DMSO_8hr_0.2", 
           "HPPTEC_CSA_8hr_2",  
           "HPPTEC_CSA_8hr_10",   
           "HPPTEC_CSA_8hr_40",   
           "HPPTEC_DMSO_24hr_0.2",
           "HPPTEC_CSA_24hr_2", 
           "HPPTEC_CSA_24hr_10",  
           "HPPTEC_CSA_24hr_40",  
           "HPPTEC_DMSO_72hr_0.2",
           "HPPTEC_CSA_72hr_2", 
           "HPPTEC_CSA_72hr_10",  
           "HPPTEC_CSA_72hr_40")
...
columns_to_remove <- c(
  ...
  "S_10_uM_CsA_8_h_P1", 
  "S_40_uM_CsA_8_h_P1", 
  "S_0.2pc_DMSO_24_h_P2", 
  "S_0.2pc_DMSO_72_h_P2", 
  "S_2_uM_CsA_72_h_P1"
)
...
order <- c(
  "S_0.2pc_DMSO_8_h_P1", "S_0.2pc_DMSO_24_h_P1", "S_2_uM_CsA_24_h_P1", "S_10_uM_CsA_24_h_P1",
  "S_40_uM_CsA_24_h_P1", "S_0.2pc_DMSO_72_h_P1", "S_10_uM_CsA_72_h_P1", "S_40_uM_CsA_72_h_P1",
  "S_0.2pc_DMSO_8_h_P2", "S_2_uM_CsA_8_h_P2", "S_10_uM_CsA_8_h_P2", "S_40_uM_CsA_8_h_P2",
  "S_2_uM_CsA_24_h_P2", "S_10_uM_CsA_24_h_P2", "S_40_uM_CsA_24_h_P2", "S_2_uM_CsA_72_h_P2",
  "S_10_uM_CsA_72_h_P2", "S_40_uM_CsA_72_h_P2", "S_0.2pc_DMSO_8_h_P3", "S_2_uM_CsA_8_h_P3",
  "S_10_uM_CsA_8_h_P3", "S_40_uM_CsA_8_h_P3", "S_0.2pc_DMSO_24_h_P3", "S_2_uM_CsA_24_h_P3",
  "S_10_uM_CsA_24_h_P3", "S_40_uM_CsA_24_h_P3", "S_0.2pc_DMSO_72_h_P3", "S_2_uM_CsA_72_h_P3",
  "S_10_uM_CsA_72_h_P3", "S_40_uM_CsA_72_h_P3"
)
...
```{r}
# Save your countdata
write_csv(filtered_countdata, file.path(output_dir, paste0(gsub( "-", "", Sys.Date()), "filtered_countdata_raw_processed_human.csv"))) 

# Save your metadata
write_csv(filtered_metadata_fsample, file.path(output_dir, paste0(gsub( "-", "", Sys.Date()), "filtered_metadata_processed_human.csv"))) 
```
